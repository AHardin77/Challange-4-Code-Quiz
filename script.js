...
const questions = [ // array of objects
    {
        ...
        answers: ["1. Apple", "2. Netscape", "3. Firefox", "4. Google"],
        correctAnswer: "2"
    },
    {
        // question 2
        question: "What are all the types of Pop up boxes available in JavaScript?",
        answers: ["1. Alert", "2. Confirm and", "3. All of the above", "4. Prompt"],
        correctAnswer: "3"
    },
    {
         // question 3
        question: "Arrays in Javascript can be used to store ____.",
        answers: ["1. booleans", "2. other arrays", "3. string", "4. all of the above"],
        correctAnswer: "1"
    },
    {
        // question 4
    ...
    {
        // question 5
        question: "What is the correct symbol to use when adding comments in Javascript!",
        answers: ["1. <!--", "2. **", "3. //", "4. /*/*"],
        correctAnswer: "3"
    }
];
...
function checkAnswer(event) {
    ...
    // answer checker events seconds removed from time clock 
